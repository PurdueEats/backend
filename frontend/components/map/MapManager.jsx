            ...
            >
                <Marker
                    coordinate={{latitude: 40.43210018,
                        longitude: -86.91955498354119}}
                    title={"Ford"}
                    description={"Dine-in/On-the-go available\n" + fordDistance + " miles away"}
                >
                </Marker>
                ...
                <Marker
                    coordinate={{latitude: 40.42688475,
                        longitude: -86.92629084966707}}
                    title={"Hillenbrand"}
                    description={"Dine-in\n" + hillenbrandDistance + " miles away"}
                />
