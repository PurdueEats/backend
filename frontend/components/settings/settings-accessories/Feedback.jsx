      ...
      return (
          <View>
              ...
              <View style={ styles.content }>
                ...
                <Text style={ [styles.textQuestion, {color: colors.text}] }>What user information does the PurdueEats app save?</Text>
                <Text style={ styles.textAnswer }>The application only saves your email, password, and meal history.</Text>
                <Text style={ [styles.textQuestion, {color: colors.text}] }>How long will it take for my submitted feedback to be considered?</Text>
                <Text style={ styles.textAnswer }>The developers of the app will most likely view feedback within a few days.</Text>
                <Text style={ [styles.textQuestion, {color: colors.text}] }>What permissions does this app need for complete functionality?</Text>
                <Text style={ styles.textAnswer }>The location permission is needed for the map function to work, and that is all.</Text>
                ...
                <TextInput style={ [styles.textEnter, {color: colors.text}] } onChangeText={(feedback) => setFeedback(feedback)} />
